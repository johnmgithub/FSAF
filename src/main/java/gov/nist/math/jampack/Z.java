...
public final class Z {
    ...
    public Z times(Z a, Z b) {
        double tre = a.re * b.re - a.im * b.im; // Required in case a or b is this
    ...
    /**
     * Product of real and imag parts of two complex values.
     * @param aRe
     * @param aIm
     * @param bRe
     * @param bIm
     * @return 
     */
    public Z times(double aRe, double aIm, double bRe, double bIm) {
        im = aIm * bRe + aRe * bIm;
        re = aRe * bRe - aIm * bIm;
        return this;
    }
